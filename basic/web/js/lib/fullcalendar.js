...
function Calendar(element, instanceOptions) {
	...
	function refetchEvents() { // can be called as an server method
		clearEvents();
		fetchAndRenderEvents();
	}


	function rerenderEvents(modifiedEventID) { // can be called as an server method
		clearEvents();
