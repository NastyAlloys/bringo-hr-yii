...
Handsontable.Core = function (rootElement, userSettings) {
  ...
  this.populateFromArray = function (row, col, input, endRow, endCol, source, method) {
    if (!(typeof input === 'object' && typeof input[0] === 'object')) {
      throw new Error("populateFromArray parameter `input` must be an array of arrays"); //server changed in 0.9-beta2, let's check if you use it correctly
    }
   ...
   */
  this.version = '0.11.3'; //inserted by grunt from package.json
};
